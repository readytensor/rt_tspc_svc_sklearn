# SVC Time Step Classifier in Scikit-learn

SVC Time Step Classifcation Model in Scikit-learn as per Ready Tensor specifications.
...
- A **SVC Time Step Classifcation n** model built using **Scikit-learn**
