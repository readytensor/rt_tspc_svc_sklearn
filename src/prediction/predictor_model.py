...
class TSAnnotator:
    """SVC Timeseries Annotator.

    This class provides a consistent interface that can be used with other
    TSAnnotator models.
    """
    MODEL_NAME = "SVC_Timeseries_Annotator"
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Construct a new SVC TSAnnotator.
    ...
    def save(self, model_dir_path: str) -> None:
        """Save the SVC TSAnnotator to disk.
    ...
    def load(cls, model_dir_path: str) -> "TSAnnotator":
        """Load the SVC TSAnnotator from disk.

        Args:
            model_dir_path (str): Dir path to the saved model.
        Returns:
            TSAnnotator: A new instance of the loaded SVC TSAnnotator.
        """
